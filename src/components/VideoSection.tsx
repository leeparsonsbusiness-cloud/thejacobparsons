  ...
  return (
    <section id="videos" className="relative py-28 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* VIDEOS GRID — DIRECT LINKS TO TIKTOK @JACOB.PARSONS_ */}
          ...
          {videos.map((video) => (
            ...
            >
              ...
              <div>
                ...
                <div className="relative aspect-[4/5] sm:aspect-[3/4] bg-[#050505] border border-white/15 overflow-hidden group-hover:border-white/40 transition-colors flex items-center justify-center">
                  {/* Real TikTok Video Thumbnail */}
                  <img
                    src={video.thumbnail}
                    alt={video.title}
                  ...
                  {/* Simulated scanlines */}
                  <div className="absolute inset-0 crt-lines pointer-events-none z-10 opacity-30" />

                  {/* Video Play Overlay */}
                  <div className="relative z-20 w-12 h-12 rounded-full border border-white/40 bg-black/75 flex items-center justify-center pl-1 group-hover:scale-110 group-hover:bg-white group-hover:text-black group-hover:border-white text-white transition-all duration-200 shadow-[0_0_20px_rgba(0,0,0,0.8)]">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                      <polygon points="6,4 20,12 6,20" />
                    </svg>
                  </div>

                  {/* TikTok Play Count Badge */}
                  <div className="absolute bottom-2 left-2 z-20 font-mono text-[10px] tracking-widest uppercase bg-black/90 text-white font-bold px-2.5 py-1 border border-white/25 flex items-center gap-1.5 shadow-lg">
                    <span>▶</span>
                    <span>{video.views}</span>
                  </div>

                  {/* Category Tag */}
                  <div className="absolute top-2 right-2 z-20 font-mono text-[9px] tracking-widest uppercase bg-black/80 text-[#ddd] px-2 py-0.5 border border-white/15">
                    {video.category === 'cinematic' ? 'FILM' : 'POV'}
                  </div>
                </div>
              ...
              <div className="mt-5 pt-3 border-t border-white/10 flex items-center justify-between font-mono text-[10px]">
                <span className="uppercase tracking-widest text-white group-hover:underline flex items-center gap-1.5 font-bold">
                  WATCH NOW <span>→</span>
                </span>
